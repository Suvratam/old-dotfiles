...
static const char col_gray3[]       = "#04b4c4";
static const char col_gray4[]       = "#F6F5F4";
static const char col_cyan[]        = "#db004c";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-h", "8", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
